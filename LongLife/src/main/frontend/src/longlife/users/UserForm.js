...
function UserForm({ onSubmit, defaultValues = {}, mode = "register" }) {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    return (
        <form className="text-start mt-4" onSubmit={handleSubmit(onSubmit)}>
            <div className="mb-3">
                ...
                />
                {errors.userId && <span style={{ color: "crimson" }}>{errors.userId.message}</span>}
            </div>
            ...
            <div className="mb-3">
                ...
                <input
                    ...
                    placeholder="cm"
                    {...register("height", { required: "키는 필수 입력입니다." })}
                />
                {errors.height && <span style={{ color: "crimson" }}>{errors.height.message}</span>}
            </div>
            ...
            <div className="mb-3">
                ...
                <input
                    ...
                    placeholder="kg"
                    {...register("weight", { required: "몸무게는 필수 입력입니다." })}
                />
